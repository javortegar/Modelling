...
# tiff(filename="C:/Users/pepe/Downloads/PPR_Biometria_simuv6.tiff",width=2419, height=1371, units="px", compression = c("none"), res=300)
par(mfrow = c(1,1), mar=c(5.1,4.1,1,1), oma=c(1.5,0,0,0),family="serif")
b <- barplot(t(simuv6), ylab="ton/ha", main="",#bty='L',#bty gives some space for ploting legend
             col=bgfill, xaxt="n", ylim=c(0,800), las=1,xlab = NA, cex.axis = 1)
# mtext("  a)", line=-1, side=3, adj=0, las=1, cex=0.8)
segments(7.3,0,7.3,4000, lty=2)
segments(10.9,0,10.9,4000, lty=2)
segments(28.9,0,28.9,4000, lty=2)
axis(1, at = b, labels=round(cpsv6$long[-ix], digits=2), las=2)
axis(side=1, at=c(0, 7.3, 10.9, 28.9, 32.5), line=4, labels=FALSE)
mtext(side=1, "Costa", line=4, at=3.7, cex=0.8)
mtext(side=1, "Depresión", line=4, at=9.1, cex=0.8)
mtext(side=1, "Intermedia", line=5, at=9.1, cex=0.8)
mtext(side=1, "Andes", line=4, at=19.9, cex=0.8)
mtext(side=1, "Estepa", line=4, at=30.7, cex=0.8)

par(fig = c(0, 1, 0, 1), oma = c(0, 0, 0, 0), mar = c(0, 0, 0, 0), new = TRUE)
plot(0, 0, type = 'l', bty = 'n', xaxt = 'n', yaxt = 'n')
legend("topright", spp.names, fill=bgfill, cex=0.7, ncol=3, inset=c(0.05,0.04))
